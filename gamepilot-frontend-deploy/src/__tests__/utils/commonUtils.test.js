...
const commonUtils_1 = require("../../../packages/shared/src/utils/commonUtils");
describe('Common Utilities', () => {
    describe('formatDate', () => {
        it('should format date correctly', () => {
            const date = new Date('2023-01-15');
            const result = (0, commonUtils_1.formatDate)(date);
    ...
    describe('formatDateTime', () => {
        it('should format date and time correctly', () => {
            ...
            const result = (0, commonUtils_1.formatDateTime)(date);
    ...
    describe('getRelativeTime', () => {
        ...
        it('should return minutes ago for recent times', () => {
            ...
            const result = (0, commonUtils_1.getRelativeTime)(date);
    ...
    describe('uniqueById', () => {
        it('should return unique items by id', () => {
            ...
            const result = (0, commonUtils_1.uniqueById)(items);
    ...
    describe('groupBy', () => {
        it('should group items by key', () => {
            ...
            const result = (0, commonUtils_1.groupBy)(items, 'category');
        ...
        it('should handle items with same key value', () => {
            ...
            const result = (0, commonUtils_1.groupBy)(items, 'status');
        ...
        it('should handle numeric keys', () => {
            ...
            const result = (0, commonUtils_1.groupBy)(items, 'priority');
    ...
    describe('hexToRgb', () => {
        it('should convert valid hex color to RGB', () => {
            const result = (0, commonUtils_1.hexToRgb)('#FF0000');
            expect(result).toEqual({ r: 255, g: 0, b: 0 });
        });
        it('should convert hex color without #', () => {
            const result = (0, commonUtils_1.hexToRgb)('00FF00');
            expect(result).toEqual({ r: 0, g: 255, b: 0 });
        });
        it('should convert hex color with lowercase', () => {
            const result = (0, commonUtils_1.hexToRgb)('#0000ff');
            expect(result).toEqual({ r: 0, g: 0, b: 255 });
        });
        it('should handle mixed case hex', () => {
            const result = (0, commonUtils_1.hexToRgb)('#AbCdEf');
            expect(result).toEqual({ r: 171, g: 205, b: 239 });
        });
        it('should return null for invalid hex', () => {
            const result = (0, commonUtils_1.hexToRgb)('invalid');
            expect(result).toBeNull();
        });
        it('should return null for incomplete hex', () => {
            const result = (0, commonUtils_1.hexToRgb)('#FFF');
            expect(result).toBeNull();
        });
        it('should return null for empty string', () => {
            const result = (0, commonUtils_1.hexToRgb)('');
            expect(result).toBeNull();
        });
        it('should return null for hex with invalid characters', () => {
            const result = (0, commonUtils_1.hexToRgb)('#GGGGGG');
            expect(result).toBeNull();
        });
    });
    describe('getContrastColor', () => {
        it('should return black for light colors', () => {
            const result = (0, commonUtils_1.getContrastColor)('#FFFFFF');
            expect(result).toBe('#000000');
        });
        it('should return white for dark colors', () => {
            const result = (0, commonUtils_1.getContrastColor)('#000000');
            expect(result).toBe('#FFFFFF');
        });
        it('should return black for medium-light colors', () => {
            const result = (0, commonUtils_1.getContrastColor)('#808080'); // Gray with brightness 128
            expect(result).toBe('#000000');
        });
        it('should return white for medium-dark colors', () => {
            const result = (0, commonUtils_1.getContrastColor)('#7F7F7F'); // Gray with brightness 127.5
            expect(result).toBe('#FFFFFF');
        });
        ...
        it('should handle invalid hex gracefully', () => {
            const result = (0, commonUtils_1.getContrastColor)('invalid');
            expect(result).toBe('#000000');
        });
        it('should handle empty string gracefully', () => {
            const result = (0, commonUtils_1.getContrastColor)('');
            expect(result).toBe('#000000');
        });
        it('should return black for bright colors', () => {
            const result = (0, commonUtils_1.getContrastColor)('#FFFF00'); // Yellow
            expect(result).toBe('#000000');
        });
        it('should return white for dark colors', () => {
            const result = (0, commonUtils_1.getContrastColor)('#000080'); // Navy
            expect(result).toBe('#FFFFFF');
        });
    });
});
