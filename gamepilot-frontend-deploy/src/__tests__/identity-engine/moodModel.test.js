...
const moodModel_1 = require("../../../packages/identity-engine/src/moodModel");
describe('MoodModel', () => {
    let moodModel;
    beforeEach(() => {
        moodModel = new moodModel_1.MoodModel();
    });
    describe('constructor', () => {
        it('should initialize with default mood weights', () => {
            const model = new moodModel_1.MoodModel();
