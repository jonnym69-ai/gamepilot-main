...
exports.searchSoundtracks = void 0;
// Mock track data
const mockTracks = [
    {
        id: '1',
...
const searchSoundtracks = async (title) => {
    // Simulate API delay
    await new Promise(resolve => setTimeout(resolve, 400));
    // Filter tracks based on title match
    const filteredTracks = mockTracks.filter(track => track.name.toLowerCase().includes(title.toLowerCase()) ||
...
exports.searchSoundtracks = searchSoundtracks;
