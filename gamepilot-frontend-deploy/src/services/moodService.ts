...
export class MoodService {
  ...
  async getMoodForecast(userId: string): Promise<MoodForecastResponse> {
    ...
    try {
      const response = await axios.get(`${this.baseUrl}/mood/forecast`, {
        params: { userId }
      })
  ...
  async getMoodResonance(userId: string): Promise<MoodResonanceResponse> {
    ...
    try {
      const response = await axios.get(`${this.baseUrl}/mood/resonance`, {
        params: { userId }
      })
      return response.data
    } catch (error) {
  ...
  async getMoodRecommendations(userId: string): Promise<MoodRecommendationsResponse> {
    ...
    try {
      const response = await axios.get(`${this.baseUrl}/mood/recommendations`, {
        params: { userId }
      })
      return response.data
    } catch (error) {
