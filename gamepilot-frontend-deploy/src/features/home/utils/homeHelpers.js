...
exports.getMockStoreRecommendations = exports.getRecentlyPlayedGames = exports.getWeightedRandomGame = void 0;
// Helper function to get weighted random game for "Surprise Me"
const getWeightedRandomGame = (games) => {
    if (games.length === 0)
        return null;
    const now = Date.now();
...
exports.getWeightedRandomGame = getWeightedRandomGame;
// Helper function to get recently played games
const getRecentlyPlayedGames = (games, limit = 8) => {
    return games
...
const getMockStoreRecommendations = (userGames) => {
...
exports.getMockStoreRecommendations = getMockStoreRecommendations;
