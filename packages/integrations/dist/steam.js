...
export class SteamIntegration {
    ...
    getMockGameDetails(appId) {
        return {
            ...
            name: 'Mock Game',
            description: 'Mock game description for testing',
            aboutTheGame: 'Mock about the game',
            ...
            platforms: ['Windows'],
            metacritic: { score: 85, url: 'https://www.metacritic.com' },
            ...
            requirements: {
                ...
                recommended: 'OS: Windows 10 64-bit, 16GB RAM'
            }
        };
    }
    /**
