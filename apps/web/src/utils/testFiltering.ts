...
import { filterGamesByMood } from './moodFilterSystem'
...
// Test each mood
const moods = ['social', 'competitive', 'story', 'adventure', 'chill', 'creative'] as const

moods.forEach(mood => {
  console.log(`\n📊 Testing ${mood} mood:`)
  const filtered = filterGamesByMood(testGames, mood)
