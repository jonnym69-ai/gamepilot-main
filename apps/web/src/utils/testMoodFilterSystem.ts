...
export function testMoodFilterSystem() {
  ...
  const socialGames = filterGamesByMood(testGames, 'social')
  ...
  const competitiveGames = filterGamesByMood(testGames, 'competitive')
  ...
  const storyGames = filterGamesByMood(testGames, 'story')
  ...
  const adventureGames = filterGamesByMood(testGames, 'adventure')
  ...
  const chillGames = filterGamesByMood(testGames, 'chill')
  ...
  const creativeGames = filterGamesByMood(testGames, 'creative')
  ...
  const validationResults = validateMoodSystem(testGames)
  ...
  const recommendations = ['social', 'competitive', 'story', 'adventure', 'chill', 'creative'].map(moodId => {
    const rec = getMoodRecommendation(testGame, moodId as MoodFilterId)
    return {
      mood: moodId,
  ...
  const socialRec = getMoodRecommendation(callOfDuty, 'social')
  const competitiveRec = getMoodRecommendation(callOfDuty, 'competitive')
