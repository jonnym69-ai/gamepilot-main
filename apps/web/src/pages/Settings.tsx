...
// Local interfaces for remaining settings
                      ...
                      <div className="flex items-start justify-between mb-6">
                        <div className="flex items-center gap-6">
                          ...
                          <div className="relative group">
                            ...
                            <button className="absolute bottom-0 right-0 w-10 h-10 bg-gaming-primary rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity shadow-lg">
                  ...
                  <div className="p-4 bg-gray-800/50 rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() => testApiKey('steam')}
                          disabled={testingApiKey === 'steam'}
                          className="px-3 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          {testingApiKey === 'steam' ? 'Testing...' : 'Test'}
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <input
                        ...
                        onChange={(e) => updateApiKey('steamApiKey', e.target.value)}
                        placeholder="Enter Steam Web API Key"
                        className="w-full px-4 py-3 bg-gray-900 text-white rounded-lg border border-gray-700 focus:border-gaming-primary focus:outline-none"
                      />
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-gray-400">
                          Get your key from Steam Web API
                        </span>
                        <button
