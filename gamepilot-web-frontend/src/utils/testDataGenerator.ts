...
const platforms = [
  { id: 'steam', name: 'Steam', code: 'steam' as any, isConnected: true },
  { id: 'epic', name: 'Epic Games', code: 'epic' as any, isConnected: false },
  { id: 'gog', name: 'GOG', code: 'gog' as any, isConnected: false },
  { id: 'origin', name: 'Origin', code: 'origin' as any, isConnected: false },
  { id: 'uplay', name: 'Uplay', code: 'uplay' as any, isConnected: false },
  { id: 'psn', name: 'PlayStation Network', code: 'psn' as any, isConnected: false },
  { id: 'xbox', name: 'Xbox Live', code: 'xbox' as any, isConnected: false },
  { id: 'switch', name: 'Nintendo Switch', code: 'switch' as any, isConnected: false }
]
const emotionalTags = ['Competitive', 'Relaxing', 'Intense', 'Strategic', 'Creative', 'Social', 'Cozy', 'Adventurous', 'Mysterious', 'Humorous']
const playStatuses: Array<'playing' | 'completed' | 'backlog' | 'abandoned' | 'unplayed'> = ['playing', 'completed', 'backlog', 'abandoned', 'unplayed']

export function generateTestGames(count: number = 100): Game[] {
  const games: Game[] = []
  ...
  for (let i = 0; i < count; i++) {
    ...
    const gamePlatforms: typeof platforms[number][] = []
    ...
    const gameEmotionalTags: string[] = []
