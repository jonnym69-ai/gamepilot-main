...
exports.generateIdentityNarrative = void 0;
/**
 * Generate a personalized gaming identity narrative
 */
const generateIdentityNarrative = (data) => {
...
const generateTimeBasedNarrative = (personaContext, analyticsInsights) => {
    ...
    if (preferredTimes.length > 0) {
        ...
        const maxTime = Object.entries(timeUsage).reduce((a, b) => b[1] > a[1] ? b : a);
 ...
 */
const generateSessionBasedNarrative = (personaContext, analyticsInsights) => {
 ...
 */
const generateMoodBasedNarrative = (personaContext, analyticsInsights) => {
 ...
 */
const generatePlayPatternNarrative = (personaContext) => {
    const playPatterns = personaContext?.recentPlayPatterns || [];
    if (playPatterns.length === 0)
        return null;
 ...
 */
const generateAchievementNarrative = (personaContext, analyticsInsights) => {
 ...
 */
const generateSocialNarrative = (personaContext) => {
 ...
 * Combine narrative parts into a cohesive story
 */
const combineNarrativeParts = (parts) => {
    if (parts.length === 0) {
