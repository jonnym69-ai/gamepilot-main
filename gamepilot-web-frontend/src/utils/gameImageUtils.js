...
exports.getHighQualityGameImage = getHighQualityGameImage;
exports.getHighQualityGameImageSources = getHighQualityGameImageSources;
function getHighQualityGameImage(game, size = '616x353') {
...
function getHighQualityGameImageSources(game) {
    return [
        // Try Steam's official game images first (highest quality)
        `https://cdn.cloudflare.steamstatic.com/steam/apps/${game.appId || game.id}/capsule_616x353.jpg`,
        `https://cdn.cloudflare.steamstatic.com/steam/apps/${game.appId || game.id}/header.jpg`,
