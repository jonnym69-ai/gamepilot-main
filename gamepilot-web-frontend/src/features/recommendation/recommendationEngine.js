...
exports.getPersonalisedRecommendation = getPersonalisedRecommendation;
// Helper function to convert library games to recommendation engine format
function convertLibraryGamesToRecommendationFormat(libraryGames) {
 ...
 */
function extractRawSignals(_persona) {
 ...
 */
function getPersonalisedRecommendation(personaProfile, libraryGames = [], rawSignals, refreshIndex = 0) {
...
function calculateGenreAffinity(gameGenres, playtimeByGenre) {
    let points = 0;
    let bestMatch = "";
...
function calculateMoodMatch(gameMoods, signals) {
    let points = 0;
    let reason = "";
...
function calculateArchetypeMatch(gamePlaystyles, archetypeId) {
    let points = 0;
    let reason = "";
...
function calculateChallengeMatch(gameDifficulty, personaDifficulty) {
...
function calculateSessionMatch(gameSession, averageMinutes) {
    let points = 0;
    let reason = "";
