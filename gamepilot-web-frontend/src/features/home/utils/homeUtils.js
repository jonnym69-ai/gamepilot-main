...
exports.getSpotlightGames = exports.getGamingGoals = exports.getGamerStats = exports.getGamerProfile = exports.getRecommendedGenres = exports.getMoodOfTheDay = void 0;
...
exports.getMoodOfTheDay = getMoodOfTheDay;
const getRecommendedGenres = () => {
    ...
    if (dayOfWeek >= 1 && dayOfWeek <= 5) {
        ...
        if (currentHour >= 14 && currentHour < 17)
            return ['Simulation', 'Racing'];
        if (currentHour >= 17 && currentHour < 20)
            return ['Sports', 'Fighting'];
...
const getGamerProfile = () => {
    ...
    return profiles[mood] || profiles.focused;
};
exports.getGamerProfile = getGamerProfile;
const getGamerStats = () => {
...
exports.getGamerStats = getGamerStats;
const getGamingGoals = () => {
    const goals = [
...
exports.getGamingGoals = getGamingGoals;
const getSpotlightGames = () => {
    return [
        {
            id: 'spotlight-1',
...
exports.getSpotlightGames = getSpotlightGames;
