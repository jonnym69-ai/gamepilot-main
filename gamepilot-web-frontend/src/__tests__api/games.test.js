...
describe('Games API Endpoints', () => {
    ...
    describe('GET /api/games/:id', () => {
        it('should return a specific game by ID', async () => {
            ...
            const gamesResponse = await request(app_1.default)
                .get('/api/games')
                .expect(200);
    ...
    describe('PUT /api/games/:id', () => {
        it('should update an existing game', async () => {
            ...
            const createResponse = await request(app_1.default)
                .post('/api/games')
                .send(newGame)
                .expect(201);
            ...
            const updateResponse = await request(app_1.default)
    ...
    describe('DELETE /api/games/:id', () => {
        it('should delete an existing game', async () => {
            ...
            const gameId = createResponse.body.id;
            // Delete the game
            const deleteResponse = await request(app_1.default)
