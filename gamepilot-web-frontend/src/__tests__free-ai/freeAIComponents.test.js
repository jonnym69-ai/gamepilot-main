...
const freeAIComponents_1 = require("../../../packages/identity-engine/src/freeAIComponents");
describe('Free AI Components', () => {
    describe('MoodEngine', () => {
        let moodEngine;
        beforeEach(() => {
            moodEngine = new freeAIComponents_1.MoodEngine();
        });
        describe('analyzeMood', () => {
            ...
            it('should handle null actions', () => {
                const result = moodEngine.analyzeMood(null);
                expect(result.mood).toBe('neutral');
                expect(result.confidence).toBe(0);
            });
        });
    ...
    describe('RecommendationEngine', () => {
        ...
        let mockGames;
        beforeEach(() => {
            recommendationEngine = new freeAIComponents_1.RecommendationEngine();
            mockGames = [
                {
                    id: 'game-1',
                    title: 'Action Game 1',
    ...
    describe('VectorSearch', () => {
        ...
        let mockGames;
        beforeEach(() => {
            vectorSearch = new freeAIComponents_1.VectorSearch();
            mockGames = [
                {
                    id: 'game-1',
                    title: 'Action Game 1',
    ...
    describe('MoodRecommendationMapper', () => {
        let moodMapper;
        beforeEach(() => {
            moodMapper = new freeAIComponents_1.MoodRecommendationMapper();
        });
    ...
    describe('SessionAnalyzer', () => {
        let sessionAnalyzer;
        beforeEach(() => {
            sessionAnalyzer = new freeAIComponents_1.SessionAnalyzer();
        });
