...
function SteamCallback() {
    ...
    const { setUser, setAuthenticated } = (0, authStore_1.useAuth)();
            ...
            const autoImportSteamGames = async () => {
                try {
                    ...
                    if (result.success && result.gameCount > 0) {
                        ...
                        const gamesWithIds = result.games.map((game) => ({
                            ...game,
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: "min-h-screen bg-gradient-to-br from-gaming-dark via-gray-900 to-gaming-darker flex items-center justify-center", children: (0, jsx_runtime_1.jsxs)("div", { className: "text-center", children: [(0, jsx_runtime_1.jsx)("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-blue-500 mx-auto mb-4" }), (0, jsx_runtime_1.jsx)("p", { className: "text-white text-lg", children: "Processing Steam authentication..." })] }) }));
}
