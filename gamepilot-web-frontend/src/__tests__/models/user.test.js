...
const sharedModels = require('../../../../packages/shared/src/index');
const { User, PlaystyleArchetype, MoodProfile, UserMoodEntry, CustomField, PlaystyleArchetypeType, MoodType, createDefaultUser, isValidUser, isValidGamingProfile, isValidPrivacySettings, isValidPreferences, isValidSocialSettings, isValidPlaystyleArchetype, isValidMoodProfile, isValidUserMoodEntry } = sharedModels;
describe('User Model', () => {
    describe('isValidUser', () => {
        ...
        it('should return false for invalid user missing required fields', () => {
            ...
            // Invalid date types
            const invalidUserBadDates = { ...invalidUser, createdAt: 'invalid-date' };
